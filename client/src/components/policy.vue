<template id="">
  <v-layout row wrap>
    ...
    <v-flex xs12 class="about">
        <h3 class="h3style">TERMS AND CONDITION</h3>
The entire company's asset website, including the layout and design along with all the content and images are protected by copyright and as such, you are not permitted to reproduce any part of the company's asset without our prior and full approval.
In continuing our promise towards investors in assuring their mining is conducted with confidence PERFECT FUNDING promotes fully transparent mining policy to its stakeholders and investors. We give you all the required mining information you need, including good rates, spreads and leverage, and other benefits of being an investor under our platform. All provided to ensure a safe and comfortable mining experience.
This is important as you never actually buy an asset when you purchase a mining option; you are simply making a speculative investment on an assets behavior over a set period of time. Mining options have gained much popularity in recent years, due to their simple up/down nature, the low cost required to participate and the increased return on investment profits (ROI).
...
These policies include:
      <ul>
        ...
        <li>Determining that clients are not known or suspected terrorist by checking their names against list of known or suspected terrorist.</li>
        ...
        <li>Not accepting cash, money orders or third party transactions</li>
        <li>Money laundering occurs when funds from an illegal/criminal activity are moved through the financial system in such a way as to make it appear that the funds have come from legitimate sources.</li>
      </ul>
Money Laundering Usually follows three stages:
      <ul>
        <li>Firstly, cash or cash equivalents are placed into the financial system.</li>
        <li>Secondly, money is transferred or moved to other accounts, through a series of financial transactions designed to obscure the origin of the money.</li>
...
CUSTOMER SERVICE
If something goes wrong, or if you have a question about an element of mining you need to know that there is someone there to help and advise you. This can be a 24-hour virtual assistant or someone on the end of the phone in mining hours. We offer a high level of customer service.
        <h3 class="h3style">MOBILE MINING</h3>
